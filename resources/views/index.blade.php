...
<!-- //for-mobile-apps -->
<link href="<?php echo url('public/css/bootstrap.css');?>" rel="stylesheet" type="text/css" media="all" />
				...
				<ul id="flexiselDemo1">			
					<li>
						<div class="wthree_testimonials_grid_main">
									...
									<img src="<?php echo url('public/images/p1.jpg');?>" alt=" " class="img-responsive" />
						</div>
					</li>
					<li>
						<div class="wthree_testimonials_grid_main">
							
									<img src="<?php echo url('public/images/p2.jpg');?>" alt=" " class="img-responsive" />
						</div>
					</li>
					<li>
						<div class="wthree_testimonials_grid_main">
						
									<img src="<?php echo url('public/images/p3.jpg');?>" alt=" " class="img-responsive" />
						</div>
					</li>
					<li>
						<div class="wthree_testimonials_grid_main">
						
									<img src="<?php echo url('public/images/p6.jpg');?>" alt=" " class="img-responsive" />
						</div>
					</li>
					<li>
						<div class="wthree_testimonials_grid_main">
						
									<img src="<?php echo url('public/images/p4.jpg');?>" alt=" " class="img-responsive" />
						</div>
					</li>
					<li>
						<div class="wthree_testimonials_grid_main">
						
									<img src="<?php echo url('public/images/p5.jpg');?>" alt=" " class="img-responsive" />
						</div>
					</li>
				</ul>
...
<div class="agile-blogs" id="blogs">
	...
	<h3 class="tittle-w3"><span>Popular </span>Recipes</h3>
		<div class="g1 agile-blog1">
			<a href="#"><img src="<?php echo url('public/images/bl1.jpg');?>" alt="blog1"></a>
				<div class="text-w3">
			         ...
			         <ul>
					  <li>
						  <div class="gallery-grid1">
								<a href="single.html"><img src="<?php echo url('public/images/s1.jpg');?>" alt=" " class="img-responsive"></a>
								<div class="p-mask">
					   ...
					   <li>
					     <div class="gallery-grid1">
							<a href="single.html"><img src="<?php echo url('public/images/s2.jpg');?>" alt=" " class="img-responsive"></a>
							<div class="p-mask">
									<h4><span>D</span>elish <span>F</span>ood</h4>
								<p>Neque porro quisquam est, qui dolorem ipsum.</p>
							</div>
						...
						<li>
						   <div class="gallery-grid1">
							<a href="single.html"><img src="<?php echo url('public/images/s3.jpg');?>" alt=" " class="img-responsive"></a>
							<div class="p-mask">
									<h4><span>D</span>elish <span>F</span>ood</h4>
								<p>Neque porro quisquam est, qui dolorem ipsum.</p>
							</div>
					    ...
					    <li>
						  <div class="gallery-grid1">
							<a href="single.html"><img src="<?php echo url('public/images/s4.jpg');?>" alt=" " class="img-responsive"></a>
							<div class="p-mask">
									<h4><span>D</span>elish <span>F</span>ood</h4>
								<p>Neque porro quisquam est, qui dolorem ipsum.</p>
							</div>
...
<!-- mail -->
			...
			<div class="copyright-wthree">
				<p>&copy; 2017 Delish Food. <span id="ajaxtest"> Ajax Click</span>
				
				<div id = 'msg' onclick="getMessage()">This message will be replaced using Ajax. 
...
<script type="text/javascript" src="<?php echo url('public/js/numscroller-1.0.js');?>"></script>
<script src="<?php echo url('public/js/particles.js');?>"></script>
...
<script type="text/javascript">
					...
					<script type="text/javascript" src="<?php echo url('public/js/jquery.flexisel.js');?>"></script>
<!--gallery-->
			...
			<script>
				$(document).ready(function(){
					...
					$('#ajaxtest').click(function () {
						...
						$.ajax({
							type: "POST",
							url: 'http://localhost/laravel5/testajax',
